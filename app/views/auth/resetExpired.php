...
<div class="container mx-auto py-12 px-4">
  <div class="flex flex-col items-center justify-center space-y-8">
    ...
    <div class="w-full md:w-7/12 text-center">
      ...
      <p class="text-gray-600 welcome-subtitle">Your password reset session has expired. Please request a new OTP to
        continue.</p>
    </div>
    <div class="w-full md:w-7/12 max-w-lg bg-white shadow-lg rounded-lg p-8 animate-fadeInUp">
      ...
      <form method="POST" action="/Worknest/public/auth/login/forgot-password/send-otp" class="space-y-4">
        <div>
