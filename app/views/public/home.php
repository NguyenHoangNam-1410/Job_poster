<?php
// SEO Meta Data
$pageTitle = 'WorkNest - Job Board & Recruitment Platform';
...
<section class="hero-bg relative min-h-screen flex flex-col items-center justify-center text-center overflow-hidden">
  ...
  <div class="absolute inset-0 opacity-10 pointer-events-none">
    <div class="absolute top-20 left-10 w-40 h-40 border-4 border-white"
      style="animation: float 8s ease-in-out infinite;"></div>
    <div class="absolute bottom-32 right-20 w-32 h-32 bg-white/20"
      style="transform: rotate(45deg); animation: float 6s ease-in-out infinite 1s;"></div>
    <div class="absolute top-1/3 right-1/4 w-24 h-24"
      style="clip-path: polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%); background: rgba(255,255,255,0.2); animation: float 7s ease-in-out infinite 2s;">
    </div>
  </div>
  ...
  <div class="container mx-auto px-6 relative z-10">
    ...
    <div class="mb-12 animate-fadeInUp">
      <h1 class="text-6xl md:text-8xl font-black text-white mb-6 leading-none tracking-tight">
        ...
        <span class="inline-block"
          style="background: linear-gradient(135deg, #b4ff39 0%, #2db8ac 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; text-shadow: none;">DREAM
          JOB</span>
      </h1>
      ...
      <div class="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
        ...
        <a href="#about" class="btn-y2k px-12 py-5 text-lg bg-white text-gray-900 hover:bg-gray-100">
          LEARN MORE
        </a>
      </div>
    </div>
    ...
    <div
      class="inline-flex flex-wrap justify-center gap-4 px-8 py-6 bg-white/10 backdrop-blur-sm border-3 border-white/30 animate-fadeInUp"
      style="animation-delay: 0.2s;">
      <a href="#about"
        class="px-6 py-2 bg-white/90 hover:bg-white text-gray-900 font-bold text-sm uppercase tracking-wide transition-all duration-300">
        About
      </a>
      <a href="#benefits"
        class="px-6 py-2 bg-white/90 hover:bg-white text-gray-900 font-bold text-sm uppercase tracking-wide transition-all duration-300">
    ...
    <div class="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
      <svg class="w-10 h-10 text-white font-bold" fill="none" stroke="currentColor" viewBox="0 0 24 24"
        stroke-width="3">
  ...
  <div class="container mx-auto px-6 max-w-6xl relative z-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="retro-card p-8 group bg-white" style="animation: slideInLeft 0.8s ease-out;">
        <div class="mb-6">
          <div
            class="w-24 h-24 mx-auto flex items-center justify-center bg-gradient-to-br from-lime-400 to-cyan-400 border-3 border-gray-900">
        ...
        <p class="text-gray-700 text-base leading-relaxed">Discover opportunities, apply with ease, and manage your
          career goals all in one powerful platform.</p>
      </div>

      <!-- Card 2 -->
      <div class="retro-card p-8 group bg-white"
        style="animation: slideInLeft 0.8s ease-out 0.1s; animation-fill-mode: both;">
        <div class="mb-6">
          <div
            class="w-24 h-24 mx-auto flex items-center justify-center bg-gradient-to-br from-pink-400 to-purple-400 border-3 border-gray-900">
        ...
        <p class="text-gray-700 text-base leading-relaxed">Post openings, connect with skilled talent, and build your
          dream team faster than ever before.</p>
      </div>

      <!-- Card 3 -->
      <div class="retro-card p-8 group bg-white"
        style="animation: slideInLeft 0.8s ease-out 0.2s; animation-fill-mode: both;">
        <div class="mb-6">
          <div
            class="w-24 h-24 mx-auto flex items-center justify-center bg-gradient-to-br from-orange-400 to-pink-400 border-3 border-gray-900">
        ...
        <p class="text-gray-700 text-base leading-relaxed">Powered by intelligent analytics to match the perfect
          candidates with the right opportunities.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container mx-auto px-6 text-center relative z-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
      ...
      <div class="retro-card p-10 text-center group bg-gradient-to-br from-cyan-100 to-lime-100">
        ...
        <p class="text-gray-700 leading-relaxed font-medium">Apply to jobs in seconds with our streamlined interface. No
          complicated forms, no hassle—just results.</p>
      </div>
      ...
      <div class="retro-card p-10 text-center group bg-gradient-to-br from-pink-100 to-purple-100">
        ...
        <p class="text-gray-700 leading-relaxed font-medium">Bank-level encryption protects your data. Your information
          is safe, secure, and never shared without permission.</p>
      </div>
      ...
      <div class="retro-card p-10 text-center group bg-gradient-to-br from-orange-100 to-pink-100">
        ...
        <p class="text-gray-700 leading-relaxed font-medium">Connect only with legitimate companies. Every employer is
          verified by our dedicated team.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container mx-auto px-6 text-center">
    ...
    <div class="mb-16 animate-fadeInUp">
      ...
      <p class="text-gray-700 text-lg max-w-3xl mx-auto font-medium">Discover how our platform revolutionizes job
        hunting in just a few minutes.</p>
    </div>
    ...
    <div class="retro-card max-w-5xl mx-auto bg-white p-6">
      <div class="relative overflow-hidden border-3 border-gray-900" style="padding-bottom: 56.25%; height: 0;">
        <iframe class="absolute top-0 left-0 w-full h-full" src="https://youtu.be/xWPJaEBIaIs?si=OJnBMzK4LNgZRlg9"
        ...
        foreach ($articles as $i => $a): ?>
          <article class="news-card retro-card overflow-hidden group bg-white">
            ...
            <div class="p-6">
              ...
              <a href="<?= htmlspecialchars($a['url'] ?? '#') ?>" <?= (isset($a['url']) && strpos($a['url'], 'http') === 0) ? 'target="_blank" rel="noopener noreferrer"' : '' ?>
  ...
  <div class="container mx-auto px-6 text-center relative z-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
      ...
      foreach ($feedbacks as $i => $f): ?>
        <div class="retro-card p-8 bg-gradient-to-br <?= $colors[$i] ?>"
          style="animation: slideInRight <?= 0.6 + ($i * 0.1) ?>s ease-out;">
          <!-- Stars -->
          ...
          <div class="pt-6 border-t-3 border-gray-900">
            <div
              class="w-16 h-16 mx-auto mb-3 bg-white border-3 border-gray-900 flex items-center justify-center text-gray-900 font-black text-2xl">
...
<section id="policies" class="policies-bg relative py-24">
  <div class="container mx-auto px-6">
    ...
    <div class="mb-16 text-center animate-fadeInUp">
      ...
      <p class="text-gray-700 text-lg max-w-2xl mx-auto font-medium">Clear guidelines to ensure a fair and professional
      ...
      <div class="retro-card bg-gradient-to-br from-lime-100 to-cyan-100" style="animation: slideInLeft 0.8s ease-out;">
        ...
        <div class="p-8 space-y-5">
          <div>
            ...
            <p class="text-gray-700 text-sm leading-relaxed">All job postings must include accurate job descriptions,
              clear requirements, and realistic salary ranges. Misleading information is strictly prohibited.</p>
          </div>
          <div>
            <h4 class="font-black text-gray-900 mb-2 uppercase text-sm">• Non-Discrimination Policy</h4>
            <p class="text-gray-700 text-sm leading-relaxed">Employers must not discriminate based on age, gender, race,
              religion, or disability. All candidates should be evaluated fairly based on qualifications.</p>
          </div>
          <div>
            <h4 class="font-black text-gray-900 mb-2 uppercase text-sm">• Candidate Privacy</h4>
            <p class="text-gray-700 text-sm leading-relaxed">Respect applicant privacy. Personal information must be
              used solely for recruitment purposes and handled according to data protection regulations.</p>
          </div>
          <div>
            <h4 class="font-black text-gray-900 mb-2 uppercase text-sm">• Timely Communication</h4>
            <p class="text-gray-700 text-sm leading-relaxed">Respond to applications within a reasonable timeframe and
              keep candidates informed about their application status.</p>
          </div>
        </div>
      </div>

      <!-- For Job Seekers -->
      <div class="retro-card bg-gradient-to-br from-pink-100 to-purple-100"
        ...
        <div class="p-8 space-y-5">
          <div>
            ...
            <p class="text-gray-700 text-sm leading-relaxed">Provide accurate and truthful information in your profile
              and applications. Misrepresentation of skills or experience may result in account suspension.</p>
          </div>
          <div>
            <h4 class="font-black text-gray-900 mb-2 uppercase text-sm">• Professional Conduct</h4>
            <p class="text-gray-700 text-sm leading-relaxed">Maintain professional communication with employers. Respond
              promptly to interview invitations and notify employers if you're no longer interested.</p>
          </div>
          <div>
            <h4 class="font-black text-gray-900 mb-2 uppercase text-sm">• Account Security</h4>
            <p class="text-gray-700 text-sm leading-relaxed">Keep your login credentials secure. Do not share your
              account with others. Report any suspicious activity immediately.</p>
          </div>
          <div>
            <h4 class="font-black text-gray-900 mb-2 uppercase text-sm">• Respect & Feedback</h4>
            <p class="text-gray-700 text-sm leading-relaxed">Treat all employers with respect. Provide constructive
              feedback about your experience to help us improve our platform.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="mt-16 max-w-5xl mx-auto">
      <div class="retro-card p-10 bg-gradient-to-br from-orange-100 to-yellow-100">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-700">
          <div>
            <p class="leading-relaxed font-medium"><strong class="text-gray-900 font-black uppercase text-sm">•
                Privacy:</strong> We protect your personal data according to international privacy standards. Your
              information will never be sold to third parties.</p>
          </div>
          <div>
          ...
          <div>
            <p class="leading-relaxed font-medium"><strong class="text-gray-900 font-black uppercase text-sm">•
                Prohibited Activities:</strong> Spam, fraudulent postings, harassment, or any illegal activities will
              result in immediate account termination.</p>
          </div>
          <div>
            <p class="leading-relaxed font-medium"><strong class="text-gray-900 font-black uppercase text-sm">• Platform
                Updates:</strong> We reserve the right to modify these policies. Users will be notified of significant
              changes via email.</p>
          </div>
        </div>
      </div>
