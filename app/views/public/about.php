    ...
    <div class="retro-card">
      ...
      <ul class="space-y-3 text-gray-700">
        <li class="flex items-start">
          ...
          <span><strong class="text-gray-900">Fast & Simple:</strong> Apply to jobs in seconds with our streamlined interface.</span>
        </li>
        <li class="flex items-start">
          <span class="font-black text-2xl text-cyan-500 mr-3">✓</span>
        ...
        <li class="flex items-start">
          <span class="font-black text-2xl text-cyan-500 mr-3">✓</span>
          <span><strong class="text-gray-900">Verified Employers:</strong> Connect only with legitimate companies.</span>
        </li>
        <li class="flex items-start">
          <span class="font-black text-2xl text-cyan-500 mr-3">✓</span>
          <span><strong class="text-gray-900">Smart Matching:</strong> AI-powered recommendations for better job matches.</span>
        </li>
      </ul>
    </div>
    ...
    <div class="retro-card">
      ...
      <div class="faq-item" style="border-bottom: none;">
        ...
        <div class="faq-answer">
          ...
          <a href="/Job_poster/public/privacy-policy" class="text-cyan-600 font-bold hover:underline">Privacy Policy</a> for more details.
        </div>
      </div>
    </div>
