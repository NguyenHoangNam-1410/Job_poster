...
<div class="list-container">
    <div class="list-content">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <a href="/Worknest/public/statistics" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
            ...
            <a href="/Worknest/public/users" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
            ...
            <a href="/Worknest/public/jobs-manage" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
            ...
            <a href="/Worknest/public/approvals" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
