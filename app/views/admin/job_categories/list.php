    ...
    <div class="list-content">
        <div class="flex justify-between items-center mb-6">
            ...
            <button
                ...
                <span
                    class="absolute inset-0 rounded-lg bg-white opacity-0 group-hover:opacity-10 transition-opacity"></span>
            </button>
            <style>
            ...
            <form method="GET" action="/Job_poster/public/job-categories" id="categoryFilterForm"
                ...
                <div class="flex-1">
                    ...
                    <input type="text" id="search" name="search"
                        ...
                        placeholder="Search by category name..." class="form-input w-full"
