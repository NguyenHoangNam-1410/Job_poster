...
<div class="form-background">
    <div class="form-container max-w-5xl">
        <div class="form-header">
            ...
            <a href="/Job_poster/public/jobs/approval" class="form-back-link">← Back to Approval List</a>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div id="rejectForm" class="hidden mt-6 p-4 bg-red-50 border border-red-200 rounded-md">
                ...
                <form id="rejectionForm" method="POST" action="/Job_poster/public/jobs/approval/reject/<?= $job->getId() ?>">
                    <textarea 
                        name="reason" 
                        rows="4" 
                        required
            ...
            <div id="approveConfirmation" class="hidden mt-6 p-4 bg-green-50 border border-green-200 rounded-md">
                ...
                <form method="POST" action="/Job_poster/public/jobs/approval/approve/<?= $job->getId() ?>">
                    <textarea 
                        name="reason" 
                        rows="4" 
