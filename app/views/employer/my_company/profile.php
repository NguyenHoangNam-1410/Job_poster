        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form id="companyForm" method="POST" action="/Job_poster/public/company-profile/update" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="border-b pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Company Logo <span class="text-red-500">*</span></h2>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            placeholder="No contact person available"
                            class="form-input w-full"
                            required
                        >
                    </div>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            placeholder="No contact phone available"
                            class="form-input w-full"
                            required
                        >
                    </div>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            required
                        ><?= htmlspecialchars($company->getDescription() ?? '') ?></textarea>
                    </div>
                </div>
